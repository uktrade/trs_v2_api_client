...
class UserObject(TRSObject):
    ...
    def add_group(self, *args):
        ...
        for group_name in args:
            result = self.custom_action(
                "put", "change_group", data={"group_name": group_name}
            )
        return result
    ...
    def delete_group(self, group_name):
        ...
        return self.custom_action(
            "delete", "change_group", data={"group_name": group_name}
        )
...
class UsersAPIClient(BaseAPIClient):
    ...
    def get_user_by_email(self, email):
        return self._get(
            self.url(f"{self.get_base_endpoint()}/get_user_by_email/{email}")
        )
